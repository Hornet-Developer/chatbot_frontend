                    ...
                    <div className="widget">
                        ...
                        <div id="main">
                            <div id="list">
                                ...
                                <button className="btn" onClick={onFiles}>Files</button>
                                <button className="btn" onClick={onText}>Text</button>
                                <button className="btn" onClick={onWebsite}>Website</button>
                            </div>
                                ...
                                <div className="upload">
                                    ...
                                    <div>
                                        {url ? (
                                            ...
                                            > 
                                                <Document file={url}>
                                                    <Page pageNumber={1} scale={0.4} renderTextLayer={false} renderAnnotationLayer={false}/>
                                                </Document>
                                            </div>
                                        ) : (
                                            <div
                                    ...
                                    <span className="upload-txt">Upload Files</span><br />
                                    <span className="attach-txt">Attach a file to see how many characters are in it</span><br/>
                                    <input type="file" id="myPdf" accept=".pdf" onChange={onChange} /><br />
                                    <span className="attach-txt">NOTE: Uploading a PDF using safari doesn't work, we're looking into the issue.Make sure the text is OCR'd, i.e. you can copy it.</span>
                                </div>
                                <button className="btn">Create Chatbot</button>
                            </div>
                            ...
                            <div id="website" style={{display: "none"}}>
                                ...
                                <span className="header-description">Max crawl/scrape time is 45 seconds (limit will increase soon)</span>
                                <div className="element">
                                    <span className="title">Crawl</span>
                                    <div className="input-form">
                                        <input className="input" placeholder="https://www.example.com"/>
                                        <button className="btn">Fetch Links</button>
                                    </div>
                                    <span className="description">This will crawl all the links starting with the URL (not including files on the website). Has to be server side rendered website</span>
                                </div>
                                <div className="or">
                                    <hr className="or-hr" />
                                ...
                                <div className="element">
                                    ...
                                    <div className="input-form">
                                        <input className="input" placeholder="https://www.example.com/sitemap.xml"/>
                                ...
                                <div className="element">
                                    ...
                                    <button className="bbtn">Create Chatbot</button>                               
                                </div>
                            </div>
                        </div>
                    </div>
